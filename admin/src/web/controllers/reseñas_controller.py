...
def reject_review(review_id):
    ...
    if len(motivo_rechazo) > 200:
        return (
            jsonify(
                {
                    "success": False,
                    "message": "El motivo de rechazo no puede superar los 200 caracteres",
                }
            ),
            400,
        )
    ...
    if success:
        ...
        return (
            jsonify({"success": False, "message": "Error al rechazar la reseña"}),
            500,
        )
...
def delete_review(review_id):
    ...
    if success:
        ...
        return (
            jsonify({"success": False, "message": "Error al eliminar la reseña"}),
            500,
        )
